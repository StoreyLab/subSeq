...
\item \texttt{DESeq2} Applies the negative binomial Wald test from the \texttt{DESeq2} package \cite{Love:2014}. DESeq2 is notable for including shrinkage on the parameters.
